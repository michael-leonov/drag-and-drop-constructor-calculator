...
function Canvas(): JSX.Element {
  return (
    <div className="w-full h-full  border-2 border-[#C4C4C4] border-dashed rounded-md flex flex-col justify-center items-center">
      <div className="mb-3">
        <svg
          width="22"
          height="22"
      ...
      <p className="text-sendsay-violet text-sm mb-1">Перетащите сюда</p>
      <p className="text-[#6B7280] text-xs w-[106px] text-center">
