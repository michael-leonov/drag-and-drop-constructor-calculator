...
function Switcher(): JSX.Element {
  return (
    <div className="bg-[#F3F4F6] flex p-px rounded-md">
      <div className="flex gap-x-2.5 items-center border-button bg-white rounded-md px-3 py-2 cursor-pointer">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
      ...
      <div className="flex gap-x-2.5 items-center px-3 cursor-pointer">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
